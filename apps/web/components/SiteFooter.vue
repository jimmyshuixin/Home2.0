...
<template>
  <footer class="site-footer">
    ...
    <p class="privacy-link"><NuxtLink to="/privacy">访问记录与隐私选择</NuxtLink></p>
...
<style scoped>
.privacy-link{margin:18px 0 0;font-size:12px}.privacy-link a{text-decoration:underline;text-underline-offset:4px}
